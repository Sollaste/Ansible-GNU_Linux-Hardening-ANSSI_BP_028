...
Ansible playbooks and roles for automated GNU/Linux hardening based on ANSSI-BP-028 recommendations. Compliance-as-code for secure system configuration.

Here is a polished README.md in English with nice Markdown structure and code blocks.

Plain text below; you can copy‑paste it directly into README.md.
